...
namespace PetVax.Repositories.Repository.BaseResponse
{
    public class GenericRepository<T> where T : class
    {
        protected readonly PetVaxContext _context;
        public GenericRepository()
        {
            _context ??= new PetVaxContext();
        }
        public GenericRepository(PetVaxContext context)
        {
            _context = context;
        }
