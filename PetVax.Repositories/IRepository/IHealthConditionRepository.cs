...
namespace PetVax.Repositories.IRepository
{
    public interface IHealthConditionRepository
    {
        ...
        Task<int> AddHealthConditionAsync(HealthCondition healthCondition, CancellationToken cancellationToken);
        Task<int> UpdateHealthConditionAsync(HealthCondition healthCondition, CancellationToken cancellationToken);
