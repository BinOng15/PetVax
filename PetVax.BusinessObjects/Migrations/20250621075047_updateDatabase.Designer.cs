...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250621075047_updateDatabase")]
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 21, 7, 50, 46, 535, DateTimeKind.Utc).AddTicks(3152),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "QHVk/pGFGTqVRmU597gwK0qwYRpfUWjFjVmlsmHy78A=",
                            PasswordSalt = "LrWwok/U96zQzcFfLuakFifOUWCsbBw4ph+4TtsAG6U=",
                            RefereshToken = "",
                            Role = 1,
                            isVerify = true
                        },
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 21, 7, 50, 46, 535, DateTimeKind.Utc).AddTicks(3157),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "EbX+1rPVJprcAOIS81LF+u1Osva2M2Ykikh0PvAcc2k=",
                            PasswordSalt = "JeCSdRxOVyDGZgACoU/wNLdwhTtd3iemIDCr/oP2Ffg=",
                            RefereshToken = "",
                            Role = 2,
                            isVerify = true
                        });
