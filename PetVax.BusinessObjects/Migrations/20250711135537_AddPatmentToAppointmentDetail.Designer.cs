...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250711135537_AddPatmentToAppointmentDetail")]
    partial class AddPatmentToAppointmentDetail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 11, 13, 55, 36, 900, DateTimeKind.Utc).AddTicks(7892),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "QhVXvJTc14SwfrsYAt+d+prX2OEQM688ip8KCkpbVWA=",
                            PasswordSalt = "KV6ozGA0yovXyqwEtPiYGLgZo3IFR8Lnz4+iEF9c+Ms=",
                            RefereshToken = "",
                            Role = 1,
                            isDeleted = false,
                            isVerify = true
                        ...
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 11, 13, 55, 36, 900, DateTimeKind.Utc).AddTicks(7905),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "LIbUDoFd19JnkEm82EUySoawkcDQubSyJ3cLWNKDN4E=",
                            PasswordSalt = "If5l1QUkI0rhUCWd7o/SJpKXe+SLCQq2Deor0aBiM5o=",
                            RefereshToken = "",
                            Role = 2,
                            isDeleted = false,
                            isVerify = true
