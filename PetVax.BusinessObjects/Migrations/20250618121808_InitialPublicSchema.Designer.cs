            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 18, 12, 18, 7, 318, DateTimeKind.Utc).AddTicks(8369),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "U/9U8WkN+7GYBqJl/8l0YA1SMqyiAGEb/+IyjkpJP7A=",
                            PasswordSalt = "+yEw+hZ7HhIpLVy5NFlrAYVAryPOoKAeKI8ui5ETnKc=",
                            RefereshToken = "",
                            Role = 1,
                            isVerify = true
                        },
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 18, 12, 18, 7, 318, DateTimeKind.Utc).AddTicks(8375),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "iqn9HI+IrCF5ETI8rwS/8T9hPyNWc2PzWC+n8f1mmtk=",
                            PasswordSalt = "jhNWBSTYZSe3Sg7P7RLmbP7Jw9tlVm8pJQYtg8GdhBM=",
                            RefereshToken = "",
                            Role = 2,
                            isVerify = true
                        });
