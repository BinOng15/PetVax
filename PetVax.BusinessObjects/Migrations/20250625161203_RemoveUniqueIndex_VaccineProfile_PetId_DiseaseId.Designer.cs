...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250625161203_RemoveUniqueIndex_VaccineProfile_PetId_DiseaseId")]
    partial class RemoveUniqueIndex_VaccineProfile_PetId_DiseaseId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 25, 16, 12, 2, 760, DateTimeKind.Utc).AddTicks(2758),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "vp1UB0tWfvY8O+3oOLsaTWGUkAqHKCt3VwCR+aNe0rQ=",
                            PasswordSalt = "539egAEbuX8Xqywpt4GQHLodNyX20DKsczCJlWoOlbQ=",
                            RefereshToken = "",
                            Role = 1,
                            isDeleted = false,
                            isVerify = true
                        ...
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 25, 16, 12, 2, 760, DateTimeKind.Utc).AddTicks(2764),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "3S9N4PY+glIsYTtPB2rZmytgU5hzxKYPlJMxpkp8bKQ=",
                            PasswordSalt = "hr/C+wxsaL7tZDdQhEdGZKuoEFD8Ol+WW0SLM+DBP9I=",
                            RefereshToken = "",
                            Role = 2,
                            isDeleted = false,
                            isVerify = true
