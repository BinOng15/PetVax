...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250606185335_deployv1")]
    partial class deployv1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 6, 18, 53, 34, 834, DateTimeKind.Utc).AddTicks(9349),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "9BPVobbIcXWO4VI9X8q8ZQpLyFFhKigXJKKYn2e9L1s=",
                            PasswordSalt = "ChnfhkJx3fu+r2FNTdOsz5vaCiz0/cC7IUbAnUknV/Y=",
                            RefereshToken = "",
                            Role = 1
                        },
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 6, 18, 53, 34, 834, DateTimeKind.Utc).AddTicks(9354),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "khJDtR17Ug/dIUHxfGzBwOsNj9CpBERN/zKLHbhIW6M=",
                            PasswordSalt = "YJdQ94Uzwu3pj+jdfLxUN7y6jG+ONbc6kSGK35c4pAE=",
                            RefereshToken = "",
                            Role = 2
                        });
                });
