...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250819100741_UpdateRelationshipOfPaymentAndAppointmentDetail")]
    partial class UpdateRelationshipOfPaymentAndAppointmentDetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 8, 19, 10, 7, 40, 480, DateTimeKind.Utc).AddTicks(852),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "HoJzl9v+5jToIKzkP2TBbHOPXA7QByhUNgS0XEfPSqY=",
                            PasswordSalt = "dZKalaCdwaetF/DzLbiUL/Bs2RLP0lH99oT30LPKpHE=",
                            RefereshToken = "",
                            Role = 1,
                            isDeleted = false,
                            isVerify = true
                        ...
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 8, 19, 10, 7, 40, 480, DateTimeKind.Utc).AddTicks(859),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "vov7kgCApeJMM3C2b8aD6PEUDiXh13h9jw7cQhLl4I0=",
                            PasswordSalt = "9vjFxsJS2Lj4NiGAf799oWRycOn2wD7oKokvm6DTjgo=",
                            RefereshToken = "",
                            Role = 2,
                            isDeleted = false,
                            isVerify = true
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.PointTransaction", b =>
                {
                    ...
                    b.HasOne("PetVax.BusinessObjects.Models.Payment", "Payment")
                        .WithOne()
                        .HasForeignKey("PetVax.BusinessObjects.Models.PointTransaction", "PaymentId")
                        .OnDelete(DeleteBehavior.Restrict);
