            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 19, 10, 57, 7, 977, DateTimeKind.Utc).AddTicks(8519),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "01tS6PniA1hQiJJrG3/hADEAUr/gyUPr3+7O/LMD1NM=",
                            PasswordSalt = "LZhb66Yvq8eaxvs96UnsMZz3FI3ecMo+3jxfJaE59VE=",
                            RefereshToken = "",
                            Role = 1,
                            isVerify = true
                        },
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 19, 10, 57, 7, 977, DateTimeKind.Utc).AddTicks(8524),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "FrzcuT197CSvxc8bD3kUWxycIXBMCCm7J9m7FsJ/m74=",
                            PasswordSalt = "syNH9manwFl15pmlMe5T5ErQJY+gxCHIUdelw4BXr1M=",
                            RefereshToken = "",
                            Role = 2,
                            isVerify = true
                        });
