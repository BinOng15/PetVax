...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250607085804_updateVet")]
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 7, 8, 58, 3, 854, DateTimeKind.Utc).AddTicks(5021),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "frKBbXeFYdasVK9epBNUxOVwVHZoFbZNolBallw1Pm4=",
                            PasswordSalt = "74o/6IC2bguzzMKzMZKd7w8+O2fv5+9P8vnysvJIQzY=",
                            RefereshToken = "",
                            Role = 1,
                            isVerify = true
                        },
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 7, 8, 58, 3, 854, DateTimeKind.Utc).AddTicks(5027),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "CXFSJXBznnCBsv8WTLZsPCBu/IBSdBHaxDkt/hsQE4s=",
                            PasswordSalt = "TDiMo122I1y3aY2ObOWAE2WN1H70qhP51BkITeRmJY4=",
                            RefereshToken = "",
                            Role = 2,
                            isVerify = true
                        });
