...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250619074001_InitialSqlServer")]
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 19, 7, 40, 0, 622, DateTimeKind.Utc).AddTicks(4991),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "5ix+4EyzOB1fFfC1BFrbiLJUggBU6FoEWAfHpVkCtGs=",
                            PasswordSalt = "ZyidMyx89zpmNJLjIj8L2k4t/vThtzWvye7pZMpfp5A=",
                            RefereshToken = "",
                            Role = 1,
                            isVerify = true
                        },
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 19, 7, 40, 0, 622, DateTimeKind.Utc).AddTicks(4997),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "e9O15o//soK+gefJ3I4FyppBYgnYnia/jhb1xIvihxo=",
                            PasswordSalt = "t5nM8JN2nmSUlpWSNWwzmsJdNZ/MnGe5RAWjBt6M4z0=",
                            RefereshToken = "",
                            Role = 2,
                            isVerify = true
                        });
