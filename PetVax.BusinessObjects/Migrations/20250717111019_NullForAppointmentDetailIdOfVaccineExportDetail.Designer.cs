...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250717111019_NullForAppointmentDetailIdOfVaccineExportDetail")]
    partial class NullForAppointmentDetailIdOfVaccineExportDetail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 17, 11, 10, 18, 973, DateTimeKind.Utc).AddTicks(7109),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "qNI4q/HYsKkPYdpkJtIjCuik+r3Afg/Gam/29egtpAg=",
                            PasswordSalt = "lsiQInOBuI1ZHArIB7uJLhy+y8MhpFThIOMGhckgIp0=",
                            RefereshToken = "",
                            Role = 1,
                            isDeleted = false,
                            isVerify = true
                        ...
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 17, 11, 10, 18, 973, DateTimeKind.Utc).AddTicks(7118),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "8g/0pIX+jppo4XBFwHXzrLF/Ac9vAPPhgOpPy0mQZh4=",
                            PasswordSalt = "v4Ynga+vEyhyL99wFGvQ6JvIDTneJ3SkFit6h1S45SU=",
                            RefereshToken = "",
                            Role = 2,
                            isDeleted = false,
                            isVerify = true
