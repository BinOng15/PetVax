...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250724155954_UpdateCustomer")]
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 24, 15, 59, 53, 721, DateTimeKind.Utc).AddTicks(8006),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "JF0GVOF6O/fkBzQR1mfxk9GDEkgtKHYqJeWqBlfEp+s=",
                            PasswordSalt = "DZ0xbFMRfgEUDxclXefm3pLBuIscESg3ASH0P0yBZ9c=",
                            RefereshToken = "",
                            Role = 1,
                            isDeleted = false,
                            isVerify = true
                        ...
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 24, 15, 59, 53, 721, DateTimeKind.Utc).AddTicks(8010),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "Cz+LAhMCrYofzHNYgR1HW21DC5f4+vapn9aLSpDlo3U=",
                            PasswordSalt = "TOhJThrmGfiP60S3yWbZndNiwfIfHi6nKJTr8QXiw9U=",
                            RefereshToken = "",
                            Role = 2,
                            isDeleted = false,
                            isVerify = true
