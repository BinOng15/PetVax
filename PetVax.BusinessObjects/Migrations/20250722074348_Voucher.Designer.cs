...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250722074348_Voucher")]
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 22, 7, 43, 47, 258, DateTimeKind.Utc).AddTicks(3965),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "AqD7kRxgZafHFUIDEB9MCAJHS4/p/+lAr9W59d9uzWw=",
                            PasswordSalt = "gBLJMX/zHFnePiEOLwMqeJlYXeDtrcHptCbxtsu61kY=",
                            RefereshToken = "",
                            Role = 1,
                            isDeleted = false,
                            isVerify = true
                        ...
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 22, 7, 43, 47, 258, DateTimeKind.Utc).AddTicks(3978),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "cTSyKpm9HW8P/aDzd+vUMBLMoKJw0hLMJvoQNXZrDXU=",
                            PasswordSalt = "Rsr2JOrtV2fjsID5GWN9YJ6X4N3Hm+IEiAXCaR0AHjU=",
                            RefereshToken = "",
                            Role = 2,
                            isDeleted = false,
                            isVerify = true
