...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250605081411_postgre_ver6")]
    partial class postgre_ver6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 5, 8, 14, 10, 579, DateTimeKind.Utc).AddTicks(7208),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "sCNBKJbd66bDPxgbZ5aCbIHVwmaMemJB7kvHuRMFDfs=",
                            PasswordSalt = "UIf9h7+gBXgKWpIxZlK5WoFyCl2cmvXrm6FqEsiVbYI=",
                            RefereshToken = "",
                            Role = 1
                        },
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 5, 8, 14, 10, 579, DateTimeKind.Utc).AddTicks(7212),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "ijHu+XZ3JQTVWSO4gOxKnIwpWFOdg3uEuSi+0QGXF9M=",
                            PasswordSalt = "7T+af0OXeHYxWzPcc8B0qMZRUc7GVVUNAGvhWTp2sTs=",
                            RefereshToken = "",
                            Role = 2
                        });
                });
