...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250709044114_update_databaseHealth")]
    partial class update_databaseHealth
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 9, 4, 41, 14, 100, DateTimeKind.Utc).AddTicks(4277),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "461xgj9a3XXOKTDuR4pasLjSXLLP7B81RKbg7aq5Jik=",
                            PasswordSalt = "cMGpAyNEsdIyjEzpR3dPUgXmtT6s2RW4RqegUoJwN9w=",
                            RefereshToken = "",
                            Role = 1,
                            isDeleted = false,
                            isVerify = true
                        ...
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 9, 4, 41, 14, 100, DateTimeKind.Utc).AddTicks(4283),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "krJdH5J2y5v1M1dcB6U+2w4LryfdgwxjJwPG5dXt2QU=",
                            PasswordSalt = "Gilp/txZRLPg3Qoj8pF7pWkJiya01HxUV6ILFNyeK7c=",
                            RefereshToken = "",
                            Role = 2,
                            isDeleted = false,
                            isVerify = true
