...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250605053650_postgre")]
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 5, 5, 36, 50, 506, DateTimeKind.Utc).AddTicks(9619),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "v5rDRaM7z7JhDE0gWTCyHA==",
                            PasswordSalt = "AT2esuw7PY7jGu1cK058NQ==",
                            RefereshToken = "",
                            Role = 1
                        },
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 6, 5, 5, 36, 50, 506, DateTimeKind.Utc).AddTicks(9623),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "iWtdnFsfg1n/5S5RlztyhA==",
                            PasswordSalt = "AT2esuw7PY7jGu1cK058NQ==",
                            RefereshToken = "",
                            Role = 2
                        });
