...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250702164010_update_database")]
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 2, 16, 40, 9, 517, DateTimeKind.Utc).AddTicks(9842),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "rfmSbjG0/9bdjywjX9IQvosXiIYETkIY/LW8AZTjPLA=",
                            PasswordSalt = "cwWXaJKNX+FpYuYESNpyfqW0rNi+QMxFLtj8bM/FYJg=",
                            RefereshToken = "",
                            Role = 1,
                            isDeleted = false,
                            isVerify = true
                        ...
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 2, 16, 40, 9, 517, DateTimeKind.Utc).AddTicks(9845),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "Mq6Y7i6zpvcLmD1OZbiZwa81z4jeklUX5ZnGaVBdZPc=",
                            PasswordSalt = "vFO3pf1SZVP5r7U/hHycbJeF4Rv5laYnRtjoI60vEnE=",
                            RefereshToken = "",
                            Role = 2,
                            isDeleted = false,
                            isVerify = true
