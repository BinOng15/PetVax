        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceToLive = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MicrochipItem_Pet_PetId1",
                        column: x => x.PetId1,
                        principalSchema: "dbo",
                        principalTable: "Pet",
                        principalColumn: "PetId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceType = table.Column<int>(type: "integer", nullable: false),
                    MicrochipItemId = table.Column<int>(type: "integer", nullable: true),
                    PassportId = table.Column<int>(type: "integer", nullable: true),
                    HealthConditionId = table.Column<int>(type: "integer", nullable: true),
                    VaccineBatchId = table.Column<int>(type: "integer", nullable: true),
                    ...
                    NextVaccinationInfo = table.Column<string>(type: "text", nullable: true),
                    AppointmentDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AppointmentStatus = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PetId = table.Column<int>(type: "integer", nullable: false),
                    DiseaseId = table.Column<int>(type: "integer", nullable: true),
                    AppointmentDetailId = table.Column<int>(type: "integer", nullable: true),
                    VaccinationScheduleId = table.Column<int>(type: "integer", nullable: true),
                    PreferedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    VaccinationDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Dose = table.Column<string>(type: "text", nullable: true),
                    Reaction = table.Column<string>(type: "text", nullable: true),
                    NextVaccinationInfo = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", new DateTime(2025, 6, 18, 11, 40, 53, 634, DateTimeKind.Utc).AddTicks(6463), "system", "admin@petvax.com", "LVyozTYbEuH9IYVS9gC2yycLh+JseNyIWGtgbphAvLo=", "t4YR5OuZAlBwzR0mgnbKJG0SYFh60OU3o/Zg0WEDHMI=", "", 1, true },
                    { 2, "", new DateTime(2025, 6, 18, 11, 40, 53, 634, DateTimeKind.Utc).AddTicks(6466), "system", "staff@petvax.com", "ijVGXvGUF9IFOitB/dxTU+0GtxkEpQ+FrcOFU1CBN9E=", "b77JRlooNvvuq67b8U1EN0No9DgHlvU4TUmg2wHaip4=", "", 2, true }
                });
