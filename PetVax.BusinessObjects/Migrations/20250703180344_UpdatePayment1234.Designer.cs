...
namespace PetVax.BusinessObjects.Migrations
{
    ...
    [Migration("20250703180344_UpdatePayment1234")]
    partial class UpdatePayment1234
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AccountId = 1,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 3, 18, 3, 43, 992, DateTimeKind.Utc).AddTicks(4766),
                            CreatedBy = "system",
                            Email = "admin@petvax.com",
                            PasswordHash = "Ffo0V0CwD0TfcKmjxh9MPKeodOBBKuXoiEHAX8HEAps=",
                            PasswordSalt = "DPcvJF7B8lpuBPUKNEU83WvxHwbN4EwcgYUFLZ6nwXQ=",
                            RefereshToken = "",
                            Role = 1,
                            isDeleted = false,
                            isVerify = true
                        ...
                        new
                        {
                            AccountId = 2,
                            AccessToken = "",
                            CreatedAt = new DateTime(2025, 7, 3, 18, 3, 43, 992, DateTimeKind.Utc).AddTicks(4771),
                            CreatedBy = "system",
                            Email = "staff@petvax.com",
                            PasswordHash = "o8KKmpfkgW+g5KVGL4+jVtxo/GfHxUU5RkD4a9VkbEI=",
                            PasswordSalt = "RJLR/f9OYswvr0u+/0Ln3k/g5THt5XPexTO2TomaBrE=",
                            RefereshToken = "",
                            Role = 2,
                            isDeleted = false,
                            isVerify = true
            ...
            modelBuilder.Entity("PetVax.BusinessObjects.Models.Payment", b =>
                {
                    ...
                    b.HasOne("PetVax.BusinessObjects.Models.Vaccine", null)
                        .WithMany("Payments")
